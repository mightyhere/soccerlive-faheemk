...
function Navbar() {
  return (
    <div className='bg-primary  h-[5rem] sm:h-[4rem]  flex justify-between   '>
        ...
        <div className=' bg-secondary w-[10rem] h-[3rem] mr-12 rounded-full mt-2 cursor-pointer hidden sm:block '>
            
        </div>
        <div className='bg-secondary w-[4rem] h-[3rem] mr-12 rounded-md mt-4  cursor-pointer  sm:hidden'>
