...
function Navbar() {
  return (
    <div className='bg-primary w-full h-[4rem] flex justify-between   '>
        <div className='flex items-center   '>
            <img   src={logo} alt="" className='w-8 h-8 mx-4' />
            <span className='text-white '>Soccerlive</span>
        </div>
        <div className=' mt-4'>
        ...
        <div className='flex bg-secondary w-[10rem] h-[3rem] mr-12 rounded-full mt-2 cursor-pointer '>
            <div>
